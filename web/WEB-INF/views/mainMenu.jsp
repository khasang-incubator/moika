...
<nav class="navbar navbar-default">
	<div class="container-fluid main-menu">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<c:url value="/" />"> <span><img
					class="logo-car" alt="CarWash" height="40" width="32"
					src="<c:url value="images/logo1.svg" />"> </span> CarWash
			</a>
		</div>
			...
			<ul class="nav navbar-nav navbar-right" id="client-reg">
				<c:choose>
					...
					<c:otherwise>
						...
						<li id="userPersonalAreaBtn" style="cursor: pointer;"><a><span
								class="glyphicon glyphicon-user" aria-hidden="true" />${userFirstName}</a>
						</li>
						<%--TODO Вставить ссылку на logout--%>
						<li id="userLogoutBtn" style="cursor: pointer;"><a><span
								class="glyphicon glyphicon-log-out" aria-hidden="true" />Выйти</a></li>
					</c:otherwise>
				</c:choose>
