	...
	<table>
		...
		<c:forEach items="${servicelist}" var="servicelist">
			<tr>
				...
				<td><c:out
						value="${servicelist.serviceEntity.washFacility.name}" /></td>
				<td><c:out value="${servicelist.serviceEntity.serviceName}" /></td>
				<td><c:out
						value="${servicelist.serviceEntity.serviceTypeEntity.typeName}" /></td>
				<td><c:out
						value="${servicelist.serviceEntity.serviceStatusEntity.statusName}" /></td>
            ...
            <td><c:out value="${servicelist.carTypeEntity.typeName}"/>
				</td
			</tr>
		</c:forEach>
	</table>
