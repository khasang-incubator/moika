...
public class ServiceSubTypeDaoImpl extends AllTypeDaoImpl<ServiceType> implements ServiceSubTypeDao {
    ...
    @Override
    public List<ServiceSubType> getServiceSubTypeBybaseType(String typeCode) throws MoikaDaoException {
    ...
    @Override
    public List<ServiceSubType> getServiceSubTypeBybaseType(int idType) throws MoikaDaoException {
        final Session session = sessionFactory.getCurrentSession();
