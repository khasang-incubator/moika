...
public class PsWashFacilityController {
    ...
    public Object deleteWashFacility(@PathVariable(value = "id") int id) {
        WashFacility washFacility = pskvorWashFacilityDaoService.getWashFacilityByID(Integer.valueOf(id));
        if (washFacility != null) {
